    ...
    const skillHobThird = [
                {
                    ...
                    description: "Je suis président de plusieurs associations de promotion du spectacle vivant, éducation populaire et humanitaire.",
                    target: "collapseFour",
                },
                {
                    Title: "Sports",
                    description: "J'apprécie le sport tant par sa pratique qu'en tant que spectateur. Que ce soit en extérieur, qu'en salle ; seul ou accompagné l'activité sportive et physique est essentiel.",
                    target: "collapseFive",
                },
                {
                    Title: "Mangas",
                    description: "J'appartiens à une génération qui a découvert les mangas au travers de la télévision, pour enfin me diriger vers les screen et les formats papiers.",
                    target: "collapseSix",
                },
            ];
