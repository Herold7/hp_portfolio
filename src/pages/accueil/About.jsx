                    ...
                    <div className="col-xl-7 container">
                        <div className="card-body">
                            ...
                            <p className="card-text p-3 ms-3 fs-3 sm" id="aboutp">
                                ...
                                des idées innovantes et de résoudre des problèmes de manière créative. 
                                Chaque projet est pour moi une nouvelle aventure où je m'efforce d'allier esthétique et fonctionnalité
